...
namespace Estagio.Nucleo.Repositorio
{
    public class RepositorioDeCliente : IRepositorio<Cliente>
    {
        ...
        public void Add(Cliente item)
        {
            ...
            var sql = @"INSERT INTO TBCLIENTES(CLIEID, CLIENOME, CLIECPFCNPJ)
 VALUES(@CLIEID,@CLIENOME,@CLIECPFCNPJ)";
            ...
            using (var cmd = DBHelper.Instancia.CrieComando(sql))
            {
                ...
                cmd.Parameters.Add(DBHelper.Instancia.CrieParametro("@CLIECPFCNPJ", item.CPFCNPJ));
                cmd.ExecuteNonQuery();
            }
        }
